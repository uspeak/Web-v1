...
function startfatFingerGame(){
    if (wordNumber <  1){
        ...
        $('#rightControl').html('<div id="btn_next" class="btn_next" onclick="processFatFingerGame();"> C</div>\n\
        <div id="btn_pause" class="btn_pause"> PAUSE</div>\n\
